package com.cabbooking.extension
...
fun Activity.goToNextScreen(cls: Class<*>) {
    startActivity(Intent(this, cls))
}

fun Activity.goToNextScreenIntent(intent: Intent) {
    startActivity(intent)
}

fun Activity.gotoStartActivity(value: Int, intent: Intent) {
